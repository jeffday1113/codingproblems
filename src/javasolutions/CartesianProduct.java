...
public class CartesianProduct {
    ...
    public void printCartesianProductRecursive(Vector<Vector<String>> lists, int index, 
                                               String current) {
        /* If index is equal to size of the list, added something from the last list, print */
        if (index == lists.size()) {
            System.out.println(current);
        } else {
            /* Index will choose which list to look in, recursive calls will increase that index 
             * each call */
